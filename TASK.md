...
4. Synthetic fixed-vs-adaptive separation demo.
5. One-shot real-data model comparison.
6. Vectorized 0/1 backtest:
   - state 0 = invested;
   - state 1 = cash;
   - apply signal delay;
...
7. Static dashboard/report:
   - CSV tables;
   - PNG figures;
   - `reports/demo_summary.md`;
   - `reports/dashboard.html`.
8. Quick and full modes for expensive scripts:
