...
Deliberately does NOT import scripts/score_grid.py or scripts/run_heldout_delay.py.
It reads the arms out of the frozen spec, then goes straight to the library
